...
//	private Document xmlDoc = null;
	...
	protected int[][] simulationField = null;
	...
	protected void showScreen() {
		...
		int maxWidth = scrnsize.width;
		int maxHeight = scrnsize.height - 80; // removes the taskbar
		
		int w;
		int h;
		
		if (maxWidth > lx*this.getOutputSizeX())
			w = lx * this.getOutputSizeX() + 30;
		else {
			lx = maxWidth/this.getOutputSizeX();
			w = maxWidth;
		}
		
		if (maxHeight > ly*this.getOutputSizeY())
			h = ly * this.getOutputSizeY() + 30;
		else {
			ly = maxHeight/this.getOutputSizeY();
			h = maxHeight;
		}
		
		this.setSize(w, h);
		
		/*if (this.getOutputSizeX() >= this.getOutputSizeY()) {
			if (maxWidth > lx*this.getOutputSizeX()) 
				this.setSize(lx * this.getOutputSizeX() + 30, l * this.getOutputSizeY() + 30);
			else {
				lx = maxWidth/this.getOutputSizeX();
				this.setSize(maxWidth, maxHeight);
			}
		} else {
			if (maxHeight > l*this.getOutputSizeY())
				this.setSize(l * this.getOutputSizeX() + 30, l * this.getOutputSizeY() + 30);
			else {
				l = maxHeight/this.getOutputSizeY();
				this.setSize(maxWidth, maxHeight);
			}
		}*/
		...
		for (int i = 3; i < this.getOutputSizeX() + 3; i++) {
			...
			for (int j = 3; j < this.getOutputSizeY() + 3; j++) {
				...
				if (simulationField[a][b] == 0) {
					...
					g.drawImage(images[0], i * lx, j * ly, lx, ly, null, null);
				...
				// paint tree
					...
					g.drawImage(images[1], i * lx, j * ly, lx, ly, null, null);
				}

				// paint switch
				else if (simulationField[a][b] == 7) {

					g.drawImage(images[7], i * lx, j * ly, lx, ly, null, null);

				}
				// paint fence
				else if (simulationField[a][b] == 6) {

					g.drawImage(images[6], i * lx, j * ly, lx, ly, null, null);
				...
				// paint cow
					...
					g.drawImage(images[2], i * lx, j * ly, lx, ly, null, null);
				}
				...
				// paint agent blue
					...
					g.drawImage(images[4], i * lx, j * ly, lx, ly, null, null);
				...
				// paint agent red
					...
					g.drawImage(images[5], i * lx, j * ly, lx, ly, null, null);
				...
				// paint controlled agent
					...
					g.drawImage(images[8], i * lx, j * ly, lx, ly, null, null);

				}
				// paint fence

				else if (simulationField[a][b] == 3) {
					g.drawImage(images[3], i * lx, j * ly, lx, ly, null, null);
				}

				// paint stable 1
				else if (simulationField[a][b] == 9) {

					g.drawImage(images[9], i * lx, j * ly, lx, ly, null, null);

				}
				// paint stable 2
				else if (simulationField[a][b] == 10) {

					g.drawImage(images[10], i * lx, j * ly, lx, ly, null, null);
